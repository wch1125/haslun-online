...
window.SpaceRun = (function() {
  ...
  function generateTrack(trackType = 'mute_city') {
    ...
    console.log(`[SpaceRun] Track generated: ${segments.length} segments, ${trackLength} units`);
  }
  ...
  function init(canvasElement) {
    ...
    console.log('[SpaceRun] Initialized');
  }
  ...
  function startRace() {
    ...
    console.log('[SpaceRun] Race starting...');
  }
  ...
  function start() {
    ...
    console.log('[SpaceRun] Game loop started');
  }
  ...
  function stop() {
    ...
    console.log('[SpaceRun] Game loop stopped');
  }
